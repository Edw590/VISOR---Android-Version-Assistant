...
:: Use cp and rm instead of mv because of a possible error (happened on miTab Advance): "failed on (...) - Cross-device link", happening because of moving across devices, it seems.
