...
public class CmdsList {
	...
	public class CmdIds {
		...
		public static final String CMD_MAKE_CALL = "18";
	...
	public class CmdRetIds {
		...
		public static final long LOCAL_MAX_SUB_CMDS = 100_000L;
	...
	public static final Map<?, ?> CMDi_INFO = new HashMap<String, String>() {
	...
	// Automated commands right here (means they need to be processed before being sent to the ACD)
	public static final String[] MAKE_CALL_CMD = {CmdsList.CmdIds.CMD_MAKE_CALL, ACD.CMDi_TYPE_MANUAL, "call", "", ""};
