...
public class CmdsList {
	...
	class CmdRetIds {
		...
		static final String RET_14_NORMAL = ".01";
		static final String RET_14_RECOVERY = ".02";
		static final String RET_14_SAFE_MODE = ".03";
	...
	static final String[][] CMDS_LIST = {
			...
			{CmdIds.CMD_ASK_BATTERY_PERCENT, ACD.CMDi_TYPE_ASK, "", "", "battery percentage", "battery status", "battery level"},                         // 12
			{CmdIds.CMD_SHUT_DOWN_DEVICE, ACD.CMDi_TYPE_SHUT_DOWN, "", "", "device/phone"},                                                               // 13
			{CmdIds.CMD_REBOOT_DEVICE, ACD.CMDi_TYPE_REBOOT, "", "", "device/phone|device/phone recovery|device/phone safe mode"},                        // 14
