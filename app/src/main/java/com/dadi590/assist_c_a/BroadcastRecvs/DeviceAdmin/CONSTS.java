...
final class CONSTS {
	...
	@NonNls static final String SPEAK_ENABLED = "Administrator mode successfully enabled to " +
			GL_CONSTS.ASSISTANT_NAME + ".";
	...
	@NonNls static final String SPEAK_DISABLED = "WARNING, ADMIN MODE REVOKED FROM " + GL_CONSTS.ASSISTANT_NAME + "!!!";
	...
	@NonNls static final String RET_STR_DISABLE_REQUESTED =
			"SECURITY WARNING!!!" +
			"\n" +
			"\n" +
