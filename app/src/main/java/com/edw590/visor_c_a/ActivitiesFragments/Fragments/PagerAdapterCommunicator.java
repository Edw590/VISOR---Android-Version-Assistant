...
public class PagerAdapterCommunicator extends FragmentStateAdapter {

	PagerAdapterCommunicator(@NonNull FragmentActivity fragmentActivity) {
	...
	public Fragment createFragment(final int position) {
		switch (position) {
			case 0:
				return new TabCommunicatorMain();
			case 1:
				return new TabCommunicatorCmdsList();
			case 2:
				return new TabCommunicatorMemories();
		}
