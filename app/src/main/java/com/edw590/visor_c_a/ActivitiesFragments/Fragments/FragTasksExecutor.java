 ...
 */
public final class FragTasksExecutor extends Fragment {
		...
		tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
			...
			public void onTabSelected(final TabLayout.Tab tab) {
				...
				switch (tab.getPosition()) {
					case 0:
						selectedFragment = new TabTasksTasksList();
						break;
					case 1:
						selectedFragment = new TabTasksAddTask();
						break;
					default:
						return;
				}
